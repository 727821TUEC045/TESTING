...
public class selenium1 {
	...
	public static void main(String[] args)  throws InterruptedException
	{
		...
		dr.findElement(By.id("input-firstname")).sendKeys("Gomathi");
		dr.findElement(By.id("input-lastname")).sendKeys("J");
		dr.findElement(By.id("input-email")).sendKeys("Gomathi@gmail.com");
